  ...
  return (
    <div className="w-full h-fit-content flex flex-col lg:flex-row items-center justify-center gap-x-0 lg:gap-x-8 gap-y-4 lg:gap-y-0">
      ...
      <div className="flex flex-col px-4 gap-y-2 max-w-xl">
        ...
        <p className="text-ap-white font-light">Member of the programming team responsible for developing the first electric and independet car at Military Engineering Institute (IME). The programming tasks involved controlling the functioning of the electronic components to optimize its performance and turn the car into self-driving.</p>    
      </div>
    </div>
  )
}