  ...
  return (
    <div className="w-full h-fit-content flex flex-col lg:flex-row items-center justify-center gap-x-0 lg:gap-x-8 gap-y-4 lg:gap-y-0">
      ...
      <div className="flex flex-col px-4 gap-y-2 max-w-xl items-center lg:items-start">
        ...
        <p className="text-ap-white font-light text-center lg:text-start">Legal and administrative representative, responsible for the strategic direction, cohesive and productive functioning of the whole company, panning and managing the callendar of all the teams of the company</p>    
      </div>
    </div>
  )
}